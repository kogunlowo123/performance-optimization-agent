"""Performance Optimization Agent — Agent Orchestrator (Plan → Research → Execute → Validate → Respond)."""
...
class AgentOrchestrator:
    """Orchestrates the Performance Optimization Agent through a multi-step pipeline.
