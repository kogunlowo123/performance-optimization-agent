"""Performance Optimization Agent - FastAPI Application."""
...
app = FastAPI(
    ...
    description="Performance engineering agent that profiles applications, identifies bottlenecks, suggests optimizations for CPU, memory, I/O, and database queries, runs benchmarks, and generates performance regression tests.",
    version="1.0.0",
    docs_url="/docs",
    redoc_url="/redoc",
    lifespan=lifespan,
